    ...
    >
      <Button
        ...
        className={`w-full justify-start h-10 px-3 ${
          isActive 
            ? 'bg-blue-100 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 border-l-2 border-blue-500' 
    ...
    <div className="w-64 h-full bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-semibold text-sm">EduPlatform Pro</h2>
            <p className="text-xs text-muted-foreground">Learning Marketplace</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        {userRole === 'admin' && (
          <div className="flex items-center justify-center mt-2 p-2 bg-red-50 dark:bg-red-900/20 rounded-lg">
            <Shield className="h-4 w-4 text-red-600 dark:text-red-400 mr-2" />
            <span className="text-xs text-red-700 dark:text-red-300">System Administration</span>
          </div>
        )}
      </div>
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 p-4 space-y-3">
        ...
        <div className="text-center">
          <p className="text-xs text-muted-foreground">
            {userRole === 'admin' ? 'System Admin v3.0' : 'Marketplace v3.0.0'}
          </p>
        </div>
      </div>
    </div>
